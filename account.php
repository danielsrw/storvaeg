                            ...
                            <form action="" method="post">
                                ...
                                <div class="group-inline u-s-m-b-30">
                                    <div class="group-2">
                                        ...
                                        <input type="number" id="phone" name="cust_phone" class="text-field" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="group-inline u-s-m-b-30">
                                    <div class="group-1 u-s-p-r-16">
                                ...
                                <div class="group-inline u-s-m-b-30">
                                    <div class="group-1">
                                        <input type="checkbox" class="check-box" id="remember-me-token">
                                        <label class="label-text" for="remember-me-token">
                                            I agree to <a href="terms-and-conditions.php">
