...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_city SET city_name=?,country_id=? WHERE city_id=?");
		$statement->execute(array($_POST['city_name'],$_POST['country_id'],$_REQUEST['id']));

    	$success_message = 'City name is updated successfully.';
    }
}
?>
...
if(!isset($_REQUEST['id'])) {
	...
	$statement = $pdo->prepare("SELECT * FROM tbl_city WHERE city_id=?");
